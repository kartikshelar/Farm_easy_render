disease_dic = {
    'Apple Scab Leaf': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    'Apple rust leaf': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Apple leaf': """ <b>Crop</b>: Apple <br/>Disease: No disease<br/>
    ...
    'Blueberry leaf': """ <b>Crop</b>: Blueberry <br/>Disease: No disease<br/>
    ...
    'Cherry leaf': """ <b>Crop</b>: Cherry <br/>Disease: No disease<br/>
    ...
    'Corn rust leaf': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn leaf blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'grape leaf black rot': """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'grape leaf': """ <b>Crop</b>: Grape <br/>Disease: No disease<br/>
    ...
    'Bell_pepper leaf spot': """ <b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Peach leaf': """ <b>Crop</b>: Peach <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Bell_pepper leaf': """ <b>Crop</b>: Pepper <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato leaf': """ <b>Crop</b>: Potato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry leaf': """ <b>Crop</b>: Raspberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soyabean leaf': """ <b>Crop</b>: Soyabean <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry leaf': """ <b>Crop</b>: Strawberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato leaf': """ <b>Crop</b>: Tomato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato leaf early blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Potato leaf late blight': """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
    ...
    'Squash Powdery mildew leaf': """ <b>Crop</b>: Squash <br/>Disease: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    'Tomato leaf bacterial spot': """ <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato Early blight leaf': """ <b>Crop</b>: Tomato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Tomato leaf late blight': """ <b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
    ...
    'Tomato mold leaf': """ <b>Crop</b>: Tomato <br/>Disease: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    'Tomato Septoria leaf spot': """ <b>Crop</b>: Tomato <br/>Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato two spotted spider mites leaf': """ <b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato leaf yellow virus': """ <b>Crop</b>: Tomato <br/>Disease: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    'Tomato leaf mosaic virus': """ <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
